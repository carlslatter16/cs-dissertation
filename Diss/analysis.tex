...
- Hiding data within something else
- Often done on images
- Steghide can be used
- Data can be executed on view of file
- Can be used to sneak data into a system, or to hide from authorities - Mr Robot CDs
- Trade off between maintaining quality and the amount of data stored.
- Criminals love reusing old malware in new and odd ways.
- It's something that is old but people don't think about, a large enthasis on networks.
- The Sundown Exploit Kit, Vawtrak and Gatak/Stegoloader  employ stenography as a vector.
- Low risk compared to other threats, it doesn't get the same numbers even with a botnet

...
%research all topics deeper than present knowledge in synthesis! just thoughts for now

%nice boxes https://tex.stackexchange.com/questions/14967/source-code-listing-with-frame-around-code

%More referencing will be coming later, shouldn't be hard to find!
...
%social aspects of a secret admirer to open the attachement
%tidy up
...
% using low power vms on perfect for defence in depth?
...
%look at the move to cold calling and threats of exposing data if they dont pay the ransom, cant just restore a backup for that, look at doppelpaymer bookmark on cyware
...
Windows works by leaving files for both reference, logs and to speed process up. These either are intrinsic to how the OS works or simply have been left behind. 

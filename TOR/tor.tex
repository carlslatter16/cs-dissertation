...
There is Hypponen's \todo{Check the spelling, it is worth finding a
spell-checker that can handle latex.} law in IOT that states, the more you add in terms of functionality, the more that must be secured. 
...
I despise\todo{the phrase ``I dispise'' is really opinion, it needs evidence.
It is a good habit to try and phrase things more objectively} the idea of security snake-oil and scare-ware, and value defence-in-depth rather than a supposed all-in-one solution.
...
\end{enumerate}
\todo[inline]{I think we would want to expand the objectives relating to the
	practical side.  The software will need some sort of analysis, deign,
build, and testing}
...
\todo{This may want splitting into analysis and synthesis parts}
